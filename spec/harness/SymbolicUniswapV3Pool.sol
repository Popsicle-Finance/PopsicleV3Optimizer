...
contract SymbolicUniswapV3Pool is IUniswapV3Pool {
	...
	// a mapping form (tickLower, tickUpper, user ) to balance
	mapping(int24 => (mapping int24 => mapping(address => uint256))) balanceOf;
    ...
    function mint(
		...
		balanceOf[tickLower][tickUpper][recipient] += amount;
    ...
    function burn(
		...
		uint256 amount =  amount0 * ratio + amount1; 
		balanceOf[tickLower][tickUpper][recipient] -= amount;
