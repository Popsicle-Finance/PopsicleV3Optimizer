certoraRun contracts/popsicle-v3-optimizer/PopsicleV3Optimizer.sol spec/harness/DummyERC20A.sol spec/harness/DummyERC20B.sol spec/harness/SymbolicUniswapV3Pool.sol \
	...
	--rule $1 \
	--settings  -enableEqualitySaturation=false,-copyLoopUnroll=4 \
