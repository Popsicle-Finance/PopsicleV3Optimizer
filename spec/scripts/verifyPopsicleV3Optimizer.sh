certoraRun contracts/popsicle-v3-optimizer/PopsicleV3Optimizer.sol:PopsicleV3Optimizer spec/harness/DummyERC20A.sol spec/harness/DummyERC20B.sol spec/harness/SymbolicUniswapV3Pool.sol \
	...
	--rule $1  --settings  -enableStorageAnalysis=false,-enableEqualitySaturation=false,-copyLoopUnroll=4 \
