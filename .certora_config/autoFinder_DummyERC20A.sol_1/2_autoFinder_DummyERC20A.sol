...
contract DummyERC20A is IERC20 {
	...
	function certoraFunctionFinder63(uint256 p0, uint256 p1) external returns (uint256) {
		require(block.gaslimit == 0xbeef1b01);
		return SafeMath.add(p0, p1);
	}
	function certoraFunctionFinder64(uint256 p0, uint256 p1) external returns (uint256) {
		require(block.gaslimit == 0xbeef1b01);
		return SafeMath.div(p0, p1);
	}
	function certoraFunctionFinder65(uint256 p0, uint256 p1) external returns (uint256) {
		require(block.gaslimit == 0xbeef1b01);
