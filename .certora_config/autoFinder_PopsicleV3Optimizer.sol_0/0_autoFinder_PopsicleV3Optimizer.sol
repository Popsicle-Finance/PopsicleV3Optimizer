...
contract PopsicleV3Optimizer is ERC20Permit, ReentrancyGuard, IPopsicleV3Optimizer {
	...
	function certoraFunctionFinder0(bytes32 p0, uint8 p1, bytes32 p2, bytes32 p3) external returns (address) {
		require(block.gaslimit == 0xbeef1b01);
		return ECDSA.recover(p0, p1, p2, p3);
	}
	function certoraFunctionFinder1(bytes32 p0, bytes32 p1) external returns (bytes32) {
		require(block.gaslimit == 0xbeef1b01);
		return ECDSA.toTypedDataHash(p0, p1);
	}
	function certoraFunctionFinder2(uint256 p0, uint256 p1, uint256 p2) external returns (uint256) {
		require(block.gaslimit == 0xbeef1b01);
		return FullMath.mulDiv(p0, p1, p2);
	}
	function certoraFunctionFinder3(uint256 p0, uint256 p1, uint256 p2) external returns (uint256) {
		require(block.gaslimit == 0xbeef1b01);
		return FullMath.mulDivRoundingUp(p0, p1, p2);
	}
	function certoraFunctionFinder4(uint160 p0, uint160 p1, uint128 p2) external returns (uint256) {
		require(block.gaslimit == 0xbeef1b01);
		return LiquidityAmounts.getAmount0ForLiquidity(p0, p1, p2);
	}
	function certoraFunctionFinder5(uint160 p0, uint160 p1, uint128 p2) external returns (uint256) {
		require(block.gaslimit == 0xbeef1b01);
		return LiquidityAmounts.getAmount1ForLiquidity(p0, p1, p2);
	}
	function certoraFunctionFinder6(uint160 p0, uint160 p1, uint160 p2, uint128 p3) external returns (uint256,uint256) {
		require(block.gaslimit == 0xbeef1b01);
		return LiquidityAmounts.getAmountsForLiquidity(p0, p1, p2, p3);
	}
	function certoraFunctionFinder7(uint160 p0, uint160 p1, uint256 p2) external returns (uint128) {
		require(block.gaslimit == 0xbeef1b01);
		return LiquidityAmounts.getLiquidityForAmount0(p0, p1, p2);
	}
	function certoraFunctionFinder8(uint160 p0, uint160 p1, uint256 p2) external returns (uint128) {
		require(block.gaslimit == 0xbeef1b01);
		return LiquidityAmounts.getLiquidityForAmount1(p0, p1, p2);
	}
	function certoraFunctionFinder9(uint160 p0, uint160 p1, uint160 p2, uint256 p3, uint256 p4) external returns (uint128) {
		require(block.gaslimit == 0xbeef1b01);
		return LiquidityAmounts.getLiquidityForAmounts(p0, p1, p2, p3, p4);
	}
	function certoraFunctionFinder10(int256 p0, int256 p1) external returns (int256) {
		require(block.gaslimit == 0xbeef1b01);
		return LowGasSafeMath.add(p0, p1);
	}
	function certoraFunctionFinder11(uint256 p0, uint256 p1) external returns (uint256) {
		require(block.gaslimit == 0xbeef1b01);
		return LowGasSafeMath.add(p0, p1);
	}
	function certoraFunctionFinder12(uint128 p0, uint128 p1) external returns (uint128) {
		require(block.gaslimit == 0xbeef1b01);
		return LowGasSafeMath.add128(p0, p1);
	}
	function certoraFunctionFinder13(uint160 p0, uint160 p1) external returns (uint160) {
		require(block.gaslimit == 0xbeef1b01);
		return LowGasSafeMath.add160(p0, p1);
	}
	function certoraFunctionFinder14(uint256 p0, uint256 p1) external returns (uint256) {
		require(block.gaslimit == 0xbeef1b01);
		return LowGasSafeMath.mul(p0, p1);
	}
	function certoraFunctionFinder15(uint128 p0, uint128 p1) external returns (uint128) {
		require(block.gaslimit == 0xbeef1b01);
		return LowGasSafeMath.mul128(p0, p1);
	}
	function certoraFunctionFinder16(uint160 p0, uint160 p1) external returns (uint160) {
		require(block.gaslimit == 0xbeef1b01);
		return LowGasSafeMath.mul160(p0, p1);
	}
	function certoraFunctionFinder17(int256 p0, int256 p1) external returns (int256) {
		require(block.gaslimit == 0xbeef1b01);
		return LowGasSafeMath.sub(p0, p1);
	}
	function certoraFunctionFinder18(uint256 p0, uint256 p1) external returns (uint256) {
		require(block.gaslimit == 0xbeef1b01);
		return LowGasSafeMath.sub(p0, p1);
	}
	function certoraFunctionFinder19(uint128 p0, uint128 p1) external returns (uint128) {
		require(block.gaslimit == 0xbeef1b01);
		return LowGasSafeMath.sub128(p0, p1);
	}
	function certoraFunctionFinder20(uint160 p0, uint160 p1) external returns (uint160) {
		require(block.gaslimit == 0xbeef1b01);
		return LowGasSafeMath.sub160(p0, p1);
	}
	function certoraFunctionFinder21(uint256 p0, uint256 p1, uint256 p2, uint256 p3) external returns (bool) {
		require(block.gaslimit == 0xbeef1b01);
		return PoolVariables.amountsDirection(p0, p1, p2, p3);
	}
	function certoraFunctionFinder22(int24 p0, int24 p1, int24 p2) external returns (int24,int24) {
		require(block.gaslimit == 0xbeef1b01);
		return PoolVariables.baseTicks(p0, p1, p2);
	}
	function certoraFunctionFinder23(int24 p0, int24 p1) external  {
		require(block.gaslimit == 0xbeef1b01);
		 PoolVariables.checkRange(p0, p1);
	}
	function certoraFunctionFinder24(int24 p0, int24 p1) external returns (int24) {
		require(block.gaslimit == 0xbeef1b01);
		return PoolVariables.floor(p0, p1);
	}
	function certoraFunctionFinder25(address p0, int24 p1, int24 p2) external returns (bytes32) {
		require(block.gaslimit == 0xbeef1b01);
		return PositionKey.compute(p0, p1, p2);
	}
	function certoraFunctionFinder26(int256 p0) external returns (int128) {
		require(block.gaslimit == 0xbeef1b01);
		return SafeCast.toInt128(p0);
	}
	function certoraFunctionFinder27(uint256 p0) external returns (int256) {
		require(block.gaslimit == 0xbeef1b01);
		return SafeCast.toInt256(p0);
	}
	function certoraFunctionFinder28(uint256 p0) external returns (uint128) {
		require(block.gaslimit == 0xbeef1b01);
		return SafeCast.toUint128(p0);
	}
	function certoraFunctionFinder29(uint256 p0) external returns (uint160) {
		require(block.gaslimit == 0xbeef1b01);
		return SafeCast.toUint160(p0);
	}
	function certoraFunctionFinder30(uint160 p0, uint128 p1, uint256 p2, bool p3) external returns (uint160) {
		require(block.gaslimit == 0xbeef1b01);
		return SqrtPriceMath.getNextSqrtPriceFromAmount0RoundingUp(p0, p1, p2, p3);
	}
	function certoraFunctionFinder31(uint160 p0, uint128 p1, uint256 p2, bool p3) external returns (uint160) {
		require(block.gaslimit == 0xbeef1b01);
		return SqrtPriceMath.getNextSqrtPriceFromAmount1RoundingDown(p0, p1, p2, p3);
	}
	function certoraFunctionFinder32(int24 p0) external returns (uint160) {
		require(block.gaslimit == 0xbeef1b01);
		return TickMath.getSqrtRatioAtTick(p0);
	}
	function certoraFunctionFinder33(uint160 p0) external returns (int24) {
		require(block.gaslimit == 0xbeef1b01);
